...
//    LinearLayout mContentLy;
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev){
        ...
        switch (action){
            case MotionEvent.ACTION_DOWN:
                Log.d("event ", "onInterceptTouchEvent触发ACTION_DOWN");
                mLastMotionY = mActionDownY = ev.getY();
                mIsBeingDragged = false;
                break;
            case MotionEvent.ACTION_MOVE:
                Log.d("event ", "onInterceptTouchEvent触发ACTION_MOVE");
            ...
            case MotionEvent.ACTION_UP:
                Log.d("event ", "onInterceptTouchEvent触发ACTION_UP");
            case MotionEvent.ACTION_CANCEL:
                Log.d("event ", "onInterceptTouchEvent触发ACTION_CANCEL");
                Log.d("******", "up or cancel");
                mIsBeingDragged = false;
                break;
        }
        ...
        if(mIsBeingDragged){
            Log.d("event ", "onInterceptTouchEvent返回true");
            return true;
        }else{
    ...
    public boolean onTouchEvent(MotionEvent ev){
        ...
        switch (aciont){
            case MotionEvent.ACTION_DOWN:
                Log.d("event ", "onTouchEvent触发ACTION_DOWN");
                Log.d("on touche down", "****");
                mLastMotionY = mActionDownY = ev.getY();
                mIsBeingDragged = false;
                break;
            case MotionEvent.ACTION_MOVE:
                Log.d("event ", "onTouchEvent触发ACTION_MOVE");
                final float y = ev.getY();
        ...
        if(mIsBeingDragged){
            Log.d("event ", "onTouchEvent返回true");
            return true;
        }else{
            Log.d("event ", "onTouchEvent返回false");
            return super.onTouchEvent(ev);
        }
    }
