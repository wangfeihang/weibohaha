...
public class DefaultHeadView extends RelativeLayout implements ILoadingLayout{
    ...
    public DefaultHeadView(Context context){
        ...
        LayoutInflater.from(context).inflate(R.layout.statu_list_refresh_header_layout, this);
    ...
    public void pullToRefresh() {
        ...
        mTitle.setText(getResources().getString(R.string.statu_list_refresh_pull_to_refresh));
    }
    ...
    public void releaseToRefresh() {
        ...
        mImageIsUp = true;
        mTitle.setText(getResources().getString(R.string.statu_list_refresh_release_to_refresh));
    }
    ...
    public void refreshing() {
        ...
        mTitle.setText(getResources().getString(R.string.statu_list_refresh_refreshing));
